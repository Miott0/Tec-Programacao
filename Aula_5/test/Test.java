...
public class Test {
    public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		//Bubble(listaDePessoas);
		//Selection(listaDePessoas);
		Insert(listaDePessoas);
	...
	private static void Bubble(ColecaoPessoas listaDePessoas){
		listaDePessoas.organizarPessoaPorBubbleSort();
	}

	private static void Selection(ColecaoPessoas listaDePessoas){
		listaDePessoas.organizarPessoaPorSelectionSort();
	}

	private static void Insert(ColecaoPessoas listaDePessoas){
		listaDePessoas.organizarPessoaPorInsertionSort();
	}
